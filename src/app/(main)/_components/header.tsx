...
// import { UserJotIdentifier } from "./userjot-identifier";
  ...
  return (
    <header className="sticky top-0 z-10 border-b bg-background/80 p-0">
      <div className="container flex items-center gap-2 px-2 py-2 lg:px-4">
        <Link className="flex items-center justify-center text-xl font-medium" href="/dashboard">
          <Logo />
        </Link>
        {user ? (
          <div className="ml-auto flex items-center gap-2">
            <RoadmapButton variant="header" />
            <SponsorButton variant="header" />
